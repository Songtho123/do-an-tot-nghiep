  ...
  <div class="row g-5">
    <div class="col-md-8">
      ...
      <article class="blog-post">
        ...
        <p class="blog-post-meta"><?php echo $row['date'];?><a href="#"><?php echo $row['admin'];?></a><a href="#"><?php echo $row['category'];?></a></p>

        <p><img class="img img-thumbnail" style="height:10%;" src="images/<?php echo $row['thumbnail'];?>"></p>
        <hr>
      ...
      <?php } ?>
            ...
            <?php
            $sql=mysqli_query($conn,"select * from news   order by id desc");
